  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-700/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-2xl mx-auto text-center p-8 bg-gray-900/80 backdrop-blur-lg rounded-2xl border border-gray-800/50">
        <div className="inline-flex items-center bg-blue-600/10 border border-blue-600/20 rounded-full px-6 py-3 mb-8">
          ...
          <span className="text-blue-400 text-sm font-bold tracking-wide">ERROR 404</span>
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl transition-all duration-300 transform hover:scale-105 font-semibold shadow-lg border border-blue-500/20"
        >
          Return Home
