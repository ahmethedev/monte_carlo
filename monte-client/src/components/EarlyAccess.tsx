...
const EarlyAccess = () => {
  ...
  return (
    <section id="early-access" className="py-24 bg-slate-950 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-emerald-600/10 rounded-full blur-3xl"></div>
        ...
        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-3xl p-12 md:p-16 shadow-2xl">
          ...
          <div className="mb-12">
            <div className="inline-flex items-center bg-emerald-600/10 border border-emerald-600/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-emerald-400 text-sm font-bold tracking-wide">LIMITED AI BETA ACCESS</span>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-gradient-to-br from-emerald-600/10 to-emerald-700/10 border border-emerald-600/20 rounded-xl p-6">
              <div className="w-12 h-12 bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-4 bg-slate-800/50 border border-slate-600 rounded-xl text-white placeholder-slate-400 focus:border-emerald-500 focus:outline-none transition-colors font-semibold"
                />
              </div>
              <Link
                to="/signup"
                className="group bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2 font-black shadow-2xl border border-emerald-500/20"
              >
          ...
          <div className="border-t border-slate-700/50 pt-10">
            ...
            <button className="group bg-gradient-to-r from-slate-800 to-slate-900 border-2 border-emerald-600/50 text-emerald-400 px-8 py-4 rounded-xl hover:border-emerald-500 hover:bg-gradient-to-r hover:from-emerald-600/10 hover:to-emerald-700/10 transition-all duration-300 flex items-center justify-center space-x-2 mx-auto font-black shadow-xl">
